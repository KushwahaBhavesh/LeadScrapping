  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-4">
        ...
        {/* Tactical Status */}
        <div className="flex gap-12 border-l border-border pl-8 hidden lg:flex">
          <div className="space-y-1">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        {/* Tech Tabs List */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-10 overflow-hidden">
          <TabsList className="bg-muted p-1.5 rounded-[24px] border border-border h-auto flex flex-wrap justify-center sm:justify-start">
            <TabsTrigger
              value="single"
              className="rounded-2xl px-8 py-3.5 data-[state=active]:bg-background data-[state=active]:text-foreground text-muted-foreground font-black text-[10px] uppercase tracking-[0.15em] transition-all duration-300 gap-3"
            >
          ...
          <div className="flex items-center gap-2 text-muted-foreground font-bold text-[10px] uppercase tracking-[0.1em] tabular-nums bg-muted px-4 py-2 rounded-xl">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <TabsContent value="single" className="mt-0 outline-none">
              <Card className="border-border bg-card shadow-2xl rounded-[40px] overflow-hidden group">
                <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-primary/10 to-transparent" />
                <div className="flex flex-col lg:flex-row">
                  <div className="lg:w-1/3 p-10 bg-muted/30 border-r border-border flex flex-col justify-between">
                    <div className="space-y-6">
                      <div className="h-14 w-14 rounded-2xl bg-background flex items-center justify-center border border-border group-hover:border-primary/50 transition-all shadow-2xl">
                      ...
                      <div className="space-y-3">
                        ...
                        <CardDescription className="text-[11px] font-bold uppercase tracking-widest text-muted-foreground leading-relaxed pr-4">
                  ...
                  <CardContent className="lg:w-2/3 p-10 lg:p-14 bg-muted/10">
                    <SingleUrlForm />
                  </CardContent>
                </div>
              </Card>
              ...
              <Card className="border-border bg-card shadow-2xl rounded-[40px] overflow-hidden group">
                ...
                <div className="flex flex-col lg:flex-row">
                  <div className="lg:w-1/3 p-10 bg-muted/30 border-r border-border flex flex-col justify-between">
                    <div className="space-y-6">
                      <div className="h-14 w-14 rounded-2xl bg-background flex items-center justify-center border border-border group-hover:border-primary/50 transition-all shadow-2xl">
                        <FilesIcon className="h-6 w-6 text-foreground" />
                      </div>
                      <div className="space-y-3">
                        <CardTitle className="text-3xl font-black uppercase tracking-tighter text-foreground">
                          Batch List
              ...
              <Card className="border-border bg-card shadow-2xl rounded-[40px] overflow-hidden group">
                ...
                <div className="flex flex-col lg:flex-row">
                  <div className="lg:w-1/3 p-10 bg-muted/30 border-r border-border flex flex-col justify-between">
                    <div className="space-y-6">
                      <div className="h-14 w-14 rounded-2xl bg-background flex items-center justify-center border border-border group-hover:border-primary/50 transition-all shadow-2xl">
                        <MapIcon className="h-6 w-6 text-foreground" />
                      </div>
                      <div className="space-y-3">
                        <CardTitle className="text-3xl font-black uppercase tracking-tighter text-foreground">
                          Sitemap Crawler
