...
const testimonials = [
  {
    quote:
      'We replaced our entire manual prospecting team with LeadScraper. The automated enrichment finds valid emails for 85% of our targets.',
    author: 'Sarah_Chen',
  ...
  {
    quote:
      'The ability to scrape LinkedIn and Maps simultaneously without getting blocked is a game changer. We scaled our outreach by 10x.',
  ...
  {
    quote:
      "Data quality is incredible. We used to get 30% bounce rates with other tools. With LeadScraper, it's consistently under 2%.",
    author: 'Elena_Vance',
  ...
  {
    quote:
      'The API integration allowed us to build a custom real-time enrichment pipeline directly into our own dashboard.',
          ...
          <div className="my-10 md:my-20 max-w-6xl mx-auto p-8 md:p-14 border border-white/5 bg-white/[0.02] rounded-[32px] md:rounded-[48px] backdrop-blur-3xl relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 relative z-10">
              {[
                ...
                <div
                  key={i}
                  className="flex flex-col items-center sm:items-start space-y-4 group/stat cursor-default"
                >
...
function TestimonialCard({ t }: { t: Testimonial }) {
  return (
    <div className="flex-shrink-0 w-full md:w-[450px] group relative p-8 md:p-12 bg-white/[0.03] border border-white/5 rounded-[32px] md:rounded-[48px] backdrop-blur-2xl shadow-xl overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-between h-full pt-8">
        ...
        <div className="mt-16 flex items-center justify-between pt-10 border-t border-white/5">
          <div className="flex items-center gap-5">
            ...
            />
            <div>
              <p className="font-black text-foreground uppercase tracking-tighter text-xl italic">
                {t.author}
              </p>
          ...
          <div className="flex flex-col items-end gap-2">
            <div className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center gap-2">
              ...
              <span className="text-[8px] font-mono text-emerald-500 font-bold tracking-widest uppercase">
                {t.status}
              </span>
            </div>
          </div>
