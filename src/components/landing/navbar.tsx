            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="md:hidden rounded-full text-foreground hover:bg-muted h-11 w-11"
                >
                ...
                <div className="flex flex-col h-full pt-20 px-8">
                  ...
                  <div className="mt-auto pb-12 space-y-4">
                    ...
                    <div className="flex items-center justify-between py-4">
                      <span className="text-[10px] font-mono font-black uppercase tracking-widest text-foreground/20">
                        Interface Mode
                      </span>
                      <ThemeToggle />
                    </div>
                    <Link href="/login" className="block">
                      <Button
                        variant="outline"
                        className="w-full h-14 rounded-2xl border-border bg-muted/20 text-xs font-black uppercase tracking-widest italic"
                      >
                        Sign In
                      </Button>
                    </Link>
