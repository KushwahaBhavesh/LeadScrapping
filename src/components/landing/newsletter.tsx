          ...
          <div className="text-left space-y-8 max-w-xl">
            ...
            <div className="hidden md:block glass rounded-2xl p-6 border-primary/5 shadow-2xl overflow-hidden group">
              <div className="flex items-center gap-2 mb-4 border-b border-foreground/5 pb-2">
                ...
                <span className="ml-2 text-[8px] font-mono text-foreground/20 font-bold tracking-widest uppercase">
                  system_feed.log
                </span>
              </div>
              <div className="space-y-2 font-mono text-[10px] text-foreground/30 font-medium">
                <p className="flex justify-between">
                  <span>[OK] Protocol: HTTP/2 Indexing</span>{' '}
                  <span className="text-primary/40">24ms</span>
                </p>
                <p className="flex justify-between">
                  <span>[OK] Agent Status: Active_Syncing</span>{' '}
                  <span className="text-primary/40">Online</span>
                </p>
                <p className="flex justify-between">
                  <span className="animate-pulse">[...] Awaiting Subscription Signal</span>{' '}
