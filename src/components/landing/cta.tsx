...
export function CTA() {
  ...
  const cardRotateX = useSpring(useTransform(mouseY, [-300, 300], [5, -5]), {
    stiffness: 100,
    damping: 30,
  });
  const cardRotateY = useSpring(useTransform(mouseX, [-300, 300], [-5, 5]), {
    stiffness: 100,
    damping: 30,
  });
    ...
    >
      ...
      <div className="md:sticky md:top-0 md:h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
          ...
          <div className="relative z-10 mt-10 h-full w-full flex flex-col items-center justify-center text-center p-8 md:p-24 space-y-12">
            ...
            >
              ...
              <span className="text-[10px] font-mono font-black uppercase tracking-[0.4em] text-primary">
                Status: Deployment_Handshake_Ready
              </span>
            </motion.div>
            ...
            <div className="space-y-6 max-w-5xl">
              ...
              <p className="text-lg md:text-2xl text-foreground/30 font-medium max-w-xl mx-auto leading-tight italic tracking-tighter">
                Stop relying on brittle scrapers. Switch to the resilient AI infrastructure trusted
                by modern growth teams.
              </p>
            </div>
              ...
              <Magnetic>
                <Link href="/register">
                  ...
                  >
                    ...
                    <span className="relative z-10 uppercase tracking-widest italic">
                      Launch_Scraper
                    </span>
              ...
              <Magnetic>
                <Link href="/docs">
                  ...
                  >
                    ...
                    <span className="uppercase tracking-[0.1em] text-foreground/40 group-hover/doc:text-foreground">
                      View_Manifest
                    </span>
        ...
        <div className="absolute bottom-10 flex flex-col items-center gap-4 opacity-10">
          ...
          <span className="text-[8px] font-mono uppercase tracking-[1em] rotate-90 origin-left ml-2">
            DEP_LOCK
          </span>
        </div>
      </div>
