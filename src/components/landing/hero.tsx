                ...
                >
                    {[
                        ...
                        <div key={i} className={cn(
                            ...
                            i < 2 ? "border-b md:border-b-0 border-black/5 dark:border-white/5" : ""
                        )}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-2xl md:text-3xl font-black tracking-tight text-foreground group-hover:text-primary transition-colors uppercase ">{item.title}</h3>
                                <p className="text-base md:text-lg text-foreground/50 font-medium leading-relaxed  tracking-tight">{item.desc}</p>
                            </div>
                        </div>
                    ))}
                </motion.div>
