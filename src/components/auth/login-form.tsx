        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-5">
                <div className="space-y-2">
                    <label className="text-[10px] font-black text-foreground/50 ml-1 uppercase tracking-widest">User_ID (Email)</label>
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between ml-1">
                        <label className="text-[10px] font-black text-foreground/50 uppercase tracking-widest">Access_Key</label>
                        <button type="button" className="text-[10px] font-bold text-primary/80 hover:text-primary hover:underline underline-offset-4 uppercase tracking-wider transition-colors">
                            Recover Key?
                        </button>
                    </div>
                    <div className="relative group">
