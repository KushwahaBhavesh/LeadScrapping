...
import { Zap, ChevronLeft, CheckCircle2, Shield, Rocket, Target, Sparkles, TrendingUp, Users, Globe } from 'lucide-react';
        ...
        return (
            <div className="w-full max-w-[440px] mx-auto">
                <motion.div
                    ...
                    className="bg-white/[0.02] border border-emerald-500/20 rounded-3xl p-12 backdrop-blur-xl text-center"
                >
                ...
                <div className="mb-12">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-foreground/40 font-medium mt-1">Create your account in seconds</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-white/5">
                        <p className="text-sm text-foreground/40 text-center">
                            ...
                            <Link href="/login" className="text-primary hover:text-white transition-all font-bold">
                                Sign in instead
                            </Link>
                        </p>
                    </div>
                ...
                <div className="mt-12 space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-foreground/40">Get started in under 60 seconds</div>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        <div className="h-6 w-6 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div className="text-sm font-bold text-foreground">Precision Targeting</div>
                            <div className="text-xs text-foreground/40">AI-powered lead extraction</div>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        <div className="h-6 w-6 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        ...
                        <div>
                            <div className="text-sm font-bold text-foreground">Enterprise Security</div>
                            <div className="text-xs text-foreground/40">Bank-level encryption & compliance</div>
                        </div>
                    </div>
                </div>
            </motion.div>
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
                                ...
                                <span className="text-xs font-mono font-bold uppercase tracking-[0.3em] text-foreground/60">Join 10,000+ Users</span>
                            </div>
                            <h2 className="text-5xl xl:text-6xl font-black text-foreground tracking-tight leading-[1.1]">
                                Your Lead Generation<br />
                                <span className="text-primary">Starts Here.</span>
                            </h2>
                            <p className="text-lg text-foreground/60 font-medium leading-relaxed max-w-[480px]">
                                Join thousands of businesses using our platform to discover, extract, and convert high-quality leads at scale.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-8 pt-8">
                            <div className="space-y-2">
                                ...
                                <div className="text-xs font-medium text-foreground/40 uppercase tracking-wider">Leads Extracted</div>
                            </div>
                            <div className="space-y-2">
                                <div className="flex items-center gap-2 text-primary">
                        ...
                        <div className="pt-8 border-t border-white/5">
                            <div className="space-y-4">
                                <p className="text-foreground/80 font-medium italic leading-relaxed">
                                    "This platform transformed our outreach. We've 10x'd our qualified leads in just 3 months."
                                </p>
