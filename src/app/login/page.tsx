...
import { Zap, ChevronLeft, Cpu, Network, TrendingUp, Users, Globe } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center p-16 xl:p-20">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="inline-block px-4 py-2 rounded-full bg-muted border border-border backdrop-blur-sm">
              ...
              <p className="text-lg text-foreground/60 font-medium leading-relaxed max-w-[480px]">
                Harness the power of intelligent lead scraping to fuel your business growth with
                precision-targeted data.
              </p>
            </div>
