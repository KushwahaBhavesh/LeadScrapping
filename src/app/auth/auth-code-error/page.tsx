          ...
          <div className="relative bg-white/[0.02] border border-red-500/10 rounded-[48px] p-8 md:p-12 backdrop-blur-3xl shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)] overflow-hidden text-center">
            <div className="relative z-10 flex flex-col items-center space-y-8">
              <div className="space-y-4">
                <h2 className="text-lg font-bold text-foreground/80 tracking-tight italic">
                  Authentication handshake failed.
                </h2>
                <p className="text-sm text-foreground/40 font-medium leading-relaxed max-w-[300px]">
                  The security token provided is no longer valid or has been revoked by the security
                  mesh.
                </p>
              </div>
              ...
              <div className="flex flex-col w-full gap-4">
                ...
                <Link href="/login" className="w-full">
                  <Button
                    variant="ghost"
                    className="w-full h-14 text-xs font-bold rounded-xl border border-white/5 hover:bg-white/5 text-foreground/40 hover:text-foreground uppercase tracking-[0.2em] transition-all"
                  >
                    Back_to_Identity
                  </Button>
                </Link>
